...
<div class="wrap"> 
	...
	<table class="form-table">
		...
		<tr>  <!-- BB Dev start-->
			<th scope="row" valign="top"><?php _e('Enable categories print?', 'wp-print'); ?></th>
			<td>
				<select name="print_cats" size="1">
					<option value="1"<?php selected('1', $print_options['cats']); ?>><?php _e('Yes', 'wp-print'); ?></option>
